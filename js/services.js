...
const servicesData = {
    website: {
        previewImage: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900&q=80",
        ...
        items: [
            ...
            },
            {
                ...
                image: "https://images.unsplash.com/photo-1537432376769-00f5c2f4c8d2?auto=format&fit=crop&w=900&q=80",
                fadeColor: "#ffffff"
            },
            {
                titlePart1: "Ecommerce ",
                ...
                image: "https://images.unsplash.com/photo-1550439062-609e1531270e?auto=format&fit=crop&w=900&q=80",
                fadeColor: "#fbfbfb"
            },
            {
                titlePart1: "Ecommerce ",
    ...
    software: {
        previewImage: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=900&q=80",
    ...
    branding: {
        previewImage: "https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&w=900&q=80",
    ...
    marketing: {
        previewImage: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=900&q=80",
    ...
    function renderTabContent(category) {
        ...
        if (cardsList) {
            ...
            data.items.forEach((item, index) => {
                ...
                let currentFadeColor = '#111418';
                if (variant === 'variant-b') currentFadeColor = '#15191e';
                if (variant === 'variant-c') currentFadeColor = '#1a1e24';
                ...
                const rightContent = `
                    <div class="premium-card-right">
                        <div class="premium-card-image-wrapper">
                            ...
                            <div class="premium-card-image-mask" style="background:linear-gradient(${isReverse ? '-90deg' : '90deg'},${currentFadeColor} 0%,transparent 65%)"></div>
                        </div>
                    </div>
                `;
